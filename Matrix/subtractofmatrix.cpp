/*4. Write a Program to find the subtraction of two matrices.*/
#include <bits/stdc++.h>
using namespace std;
int main()
{
    ...
    for (int out = 1; out <= i; out++)
    {
        ...
        {
            sum = arr[out][outp] - arry[out][outp]; // subtracting elements just change name of array dimention will be same
